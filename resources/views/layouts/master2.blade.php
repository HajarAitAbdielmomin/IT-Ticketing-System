...
<link href="{{asset('images/help.png')}}" rel="icon">
   ...
   <!-- <link href=" {{ asset('vendor_/css-hamburgers/hamburgers.min.css') }} " rel="stylesheet" media="all"> -->
    ...
    <link href=" {{ asset('vendor_/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
...
<div class="page-wrapper">
     <!-- MENU SIDEBAR-->
     @include('pages.ClientPages.partials.menu')
     <!-- end MENU SIDEBAR-->

     <div class="page-container2">
       <!-- HEADER DESKTOP-->
       @include('pages.ClientPages.partials.header')
         <!-- HEADER DESKTOP-->
    ...
    @include('pages.ClientPages.partials.footer')  
    </div>
    ...
    <script src=" {{ asset('vendor_/datatables/jquery.dataTables.min.js') }}"></script>
    <script src=" {{ asset('vendor_/datatables/dataTables.bootstrap4.min.js') }}"></script>
    ...
    <script src="{{ asset('vendor_/select2/select2.min.js') }}"> </script>   
     -->
