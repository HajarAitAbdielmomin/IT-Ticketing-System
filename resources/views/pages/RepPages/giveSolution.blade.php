...
@section('title','Suggest a solution')


@section('content')

<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Contact with client</h1>
          </div>
            ...
            <div class="d-flex flex-column comment-section">
                ...
                @foreach ($messages as $message)
                 ...
                 <div class="d-flex flex-row align-items-start">
                    ...
                    @else 
                    <img class="rounded-circle" src="{{ asset('images/'.$client->image )}}" width="40">&nbsp;&nbsp;	                     
               ...
               <form  action="{{url('answerClient')}}" method="POST">
               {{ csrf_field() }}
                 <div class="bg-light p-2">
                    <input type="hidden" value="{{ $ticket->id }}" name="idT">
                    <input type="hidden" value="{{ $client->id }}" name="idCreator">
